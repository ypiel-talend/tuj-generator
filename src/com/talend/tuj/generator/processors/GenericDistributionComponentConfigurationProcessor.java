...
public class GenericDistributionComponentConfigurationProcessor implements IProcessor {
    ...
    public void process(IElement component) {
        ...
        if (componentName.startsWith("tHDFS") || componentName.startsWith("tSqoop") || componentName.startsWith("tMysql")) {
        ...
        } else if (componentName.startsWith("tRedshift") || componentName.startsWith("tDynamoDB") || componentName.startsWith("tS3") || componentName.startsWith("tAzureFS")) {
